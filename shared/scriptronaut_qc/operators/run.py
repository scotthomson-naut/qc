...
class SCRIPTRONAUT_OT_QC_RunSelected(Operator):
    ...
    def execute(
        ...
        # Sum of time spent executing check main() functions only.
        # This deliberately excludes forced UI redraws, module loading,
        # result serialization and other QC runner overhead.
        check_processing_elapsed = 0.0
